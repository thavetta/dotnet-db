...
var cs = builder.Configuration.GetConnectionString("SqlServer") ?? "Server=localhost;Database=Demo03_Bookings_MappingAdvanced;Trusted_Connection=True;TrustServerCertificate=True;";
